...
def Hola(): #creamos la función que va a responder al llamado a  la ruta /
    return '<h1>Bienvenido al sitio web de Aaron</h1>' #es lo que devuelve la función es este caso solo un texto (hola mundo)
@app.route('/plantilla')
def plantilla():
    data={
        'titulo':'',
        'mensaje':'Hola soy un alumno del tecnologico'
